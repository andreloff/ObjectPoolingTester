...
public class PoolingTankBehaviour : MonoBehaviour
{
    ...
    private void Shoot()
    {
        PoolingProjectileBehaviour newProjectile = ProjectilePoolingManager.Instance.GetAvailableProjectile();

        newProjectile.Activate(_projectileSpawnPosition.position);
    }
